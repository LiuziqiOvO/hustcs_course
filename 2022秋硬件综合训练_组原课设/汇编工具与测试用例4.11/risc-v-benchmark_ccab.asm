...
#SRLV移位测试    revise date2021124 tiger
...
ecall                  # print
addi t3,t3, -1    
bne t3,zero,srl_branch   #循环8??

addi   a7,zero,10         # system call for exit
ecall                  # we are out of here.   


#XOR测试    revise date2021124 tiger
...
ecall                  # print
addi t3,t3, -1    
bne t3,zero,xor_branch   #循环8??

addi   a7,zero,10         # system call for exit
ecall                  # we are out of here.   


#LBU 测试   revise date2021124 tiger
...
#预先写入数据，实际是按字节顺序存?? 0x81,82,84,86,87,88,89.......等差数列
addi s1,zero,  0x84
slli s1,s1,8
addi s1,s1,0x83 
addi s2,zero,  0x04
...
#blt 测试    小于0跳转   累加运算，从负数??始向零运?? revise date2022124 tiger  
