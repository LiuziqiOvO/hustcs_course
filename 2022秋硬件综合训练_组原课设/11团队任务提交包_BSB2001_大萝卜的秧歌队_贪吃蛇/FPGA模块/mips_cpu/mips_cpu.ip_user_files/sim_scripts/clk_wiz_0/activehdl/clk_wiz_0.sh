...
#
# Generated by Vivado on Wed Oct 19 20:00:47 +0800 2022
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/lmq/yanshou/cpu_for_tw/Single_Cycle_CPU/Single_Cycle_CPU_1_int/mips_cpu/mips_cpu.cache/compile_simlib/activehdl"
  fi
