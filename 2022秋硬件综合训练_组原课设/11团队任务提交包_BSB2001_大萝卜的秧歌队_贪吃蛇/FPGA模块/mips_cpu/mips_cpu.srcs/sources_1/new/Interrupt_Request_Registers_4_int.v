...
module Interrupt_Request_Register_4_int( CLK,
                                   IR1,
                                   IR2,
                                   IR3,
                                   IR4,
   ...
   D_Flip_Flop D_Flip_1_1(//ÓÒ±ßµÄD´¥·¢Æ÷
        .Clock(CLK),
        .D((D_Flip_1_Q_0 || D_Flip_1_Q_1) && (~RST_IR1)),
        .Q(D_Flip_1_Q_1),
        .Reset(RST),
        .Preset(0)  
   );
   ...
   D_Flip_Flop D_Flip_2_0(//×ó±ßµÄD´¥·¢Æ÷
      ...
      D_Flip_Flop D_Flip_2_1(//ÓÒ±ßµÄD´¥·¢Æ÷
           .Clock(CLK),
           .D((D_Flip_2_Q_0 || D_Flip_2_Q_1) && (~RST_IR2)),
           .Q(D_Flip_2_Q_1),
           .Reset(RST),
           .Preset(0)  
      );
     ...
     D_Flip_Flop D_Flip_3_1(//ÓÒ±ßµÄD´¥·¢Æ÷
          .Clock(CLK),
          .D((D_Flip_3_Q_0 || D_Flip_3_Q_1) && (~RST_IR3)),
          .Q(D_Flip_3_Q_1),
          .Reset(RST),
          .Preset(0)  
     );
  ...
  D_Flip_Flop D_Flip_4_0(//×ó±ßµÄD´¥·¢Æ÷
    ...
    D_Flip_Flop D_Flip_4_1(//ÓÒ±ßµÄD´¥·¢Æ÷
         .Clock(CLK),
         .D((D_Flip_4_Q_0 || D_Flip_4_Q_1) && (~RST_IR4)),
         .Q(D_Flip_4_Q_1),
         .Reset(RST),
         .Preset(0)  
    );
