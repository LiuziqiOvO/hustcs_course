...
HD_PWD='D:/MyFile/code/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log auto_add_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source auto_add_tb.tcl
